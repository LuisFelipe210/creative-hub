...
const ButterflySVG = ({
    ...
    return (
        <div
            className={`absolute ${driftSpeed} ${className} z-0 pointer-events-none`}
            style={{
        ...
        >
            <div className={`${flutterSpeed} origin-center`}>
                ...
                >
                    <g transform="translate(0.000000,805.000000) scale(0.100000,-0.100000)" fill="currentColor" stroke="none">
...
export default ButterfliesScene;