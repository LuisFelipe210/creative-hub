...
const NotFound = () => {
    return (
        <main className="min-h-screen flex flex-col selection:bg-black selection:text-primary bg-dots-pattern relative overflow-hidden">
            ...
            {/* --- BORBOLETA 1: FUNDO GIGANTE (PREENCHIMENTO) --- */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 pointer-events-none">
                <ButterflyLogo
                    className="w-[800px] h-[800px] text-primary opacity-[0.03] rotate-12"
                />
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center container mx-auto px-4 py-20 relative z-10">
                ...
                <div className="relative group max-w-lg w-full">
                    ...
                    <div className="bg-[#fffbff] border-2 border-black rounded-3xl overflow-hidden relative">
                        ...
                        <div className="bg-black text-white py-2 px-6 flex justify-between items-center border-b-2 border-black relative z-20">
                        ...
                        <div className="p-10 md:p-14 text-center relative z-10">
                            ...
                            {/* BORBOLETA 2: TEXTURA DENTRO DO CARD */}
                            <ButterflyLogo
                                className="absolute bottom-4 left-4 w-40 h-40 text-gray-200 rotate-[-15deg] pointer-events-none -z-10"
                                opacity={0.5}
                            />
                            ...
                            <div className="relative mb-8 inline-block">
                                ...
                                {/* Badge Flutuante */}
                                <div className="absolute -top-6 -right-10 bg-white text-black text-xs font-bold px-3 py-1 border-2 border-black rotate-12 shadow-sm z-20">
                                    SUMIU!
                                </div>
                            </div>
                            ...
                            <p className="text-gray-600 font-medium text-base leading-relaxed mb-8 max-w-sm mx-auto relative z-10">
