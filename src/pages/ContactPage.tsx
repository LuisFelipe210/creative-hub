                ...
                <div className="pt-2 border-t-2 border-gray-100">
                    <div className="flex items-start mt-3">
                        ...
                        <label htmlFor="consent" className="text-[11px] text-gray-700 font-medium leading-relaxed">
                            Eu li e concordo com o uso dos meus dados (Nome e Email) **apenas para responder** à minha solicitação de contato.
            ...
            <div className="bg-dots-pattern w-full relative z-0">
                <div className="container mx-auto px-4 pt-16 pb-16">
                        ...
                        <div className="lg:w-5/12 flex flex-col gap-4 w-full animate-in slide-in-from-bottom duration-700 delay-200 fill-mode-both">
                            <div className="bg-[#fffbff] border-2 border-black p-6 rounded-2xl shadow-[8px_8px_0px_0px_#000000] flex flex-col justify-between">
                                ...
                                <div>
                                    ...
                                    {/* ENVELOPE CARD: Espaçamento reduzido */}
                                    ...
                                    {/* FIM DO ENVELOPE CARD */}
                                </div>
                                <div className="space-y-2"> {/* ESPAÇAMENTO COMPACTADO: space-y-2 */}
                                    <a href="https://wa.me/5574991394805" target="_blank" rel="noopener noreferrer" className="group block bg-gray-50 border-2 border-gray-200 py-3 px-4 rounded-xl hover:border-primary hover:bg-black transition-all duration-300"> {/* PADDING VERTICAL REDUZIDO: py-3 */}
                                    ...
                                    <a href="https://www.instagram.com/brandcriativo/" target="_blank" rel="noopener noreferrer" className="group block bg-gray-50 border-2 border-gray-200 py-3 px-4 rounded-xl hover:border-primary hover:bg-black transition-all duration-300"> {/* PADDING VERTICAL REDUZIDO: py-3 */}
                                        <div className="flex justify-between items-center">
                                            <div className="flex items-center gap-3">
                                    ...
                                    {/* EMAIL (Original) */}
                                    <a href="mailto:Trajanoiasmim9@gmail.com" className="group block bg-gray-50 border-2 border-gray-200 py-3 px-4 rounded-xl hover:border-primary hover:bg-black transition-all duration-300"> {/* PADDING VERTICAL REDUZIDO: py-3 */}
                                        <div className="flex justify-between items-center">
                                            <div className="flex items-center gap-3">
                    ...
                    <div className="border-t-2 border-black pt-12 animate-in slide-in-from-bottom duration-700 delay-500 fill-mode-both">
                        ...
                        {/* CARDS BRUTALISTAS ATUALIZADOS */}
                        <div className="grid md:grid-cols-3 gap-6">
                            {/* Card 1: Orçamentos (Mail) */}
                        ...
                        {/* FIM DOS CARDS BRUTALISTAS ATUALIZADOS */}
                    </div>
                </div>
                <Footer />
            </div>
